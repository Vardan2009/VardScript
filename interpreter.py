...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'ret', 'cont', 'brk', 'set', 'if', 'for', 'while', 'func', int, float, identifier, '+', '-', '(', '[' or 'not'"
      ))
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_halt(self, exec_ctx):
    exit()
    return None
  execute_halt.arg_names = []
  ...
  def execute_select(self, exec_ctx):
    ...
    if not (isinstance(list_, List) or isinstance(list_, String)):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
  ...
  def execute_run(self, exec_ctx):
    ...
    try:
          ...
          if file_extension != ".vard":
            raise Exception("Not a .vard file!")
          with open(fn, "r") as f:
            script = f.read()
...
BuiltInFunction.halt 		= BuiltInFunction("halt");
...
global_symbol_table.set("undef", Number.null)
...
global_symbol_table.set("in", BuiltInFunction.input)
global_symbol_table.set("inint", BuiltInFunction.input_int)
global_symbol_table.set("clear", BuiltInFunction.clear)
global_symbol_table.set("cls", BuiltInFunction.clear)
global_symbol_table.set("halt", BuiltInFunction.halt)
